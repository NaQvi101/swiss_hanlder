    ...
    <Navbar bg="light" variant="light" className="py-3 shadow-lg " expand="lg">
      <Container>
        <Button
          ...
          className="text-[#cb202c]  border-[#cb202c] p-0  min-w-9 min-h-9  hover:border-[#cb202c] border-1 hover:bg-transparent mr-1 hover:text-[#cb202c]"
        >
        ...
        <Navbar.Toggle
          className="text-[#cb202c] border-[#cb202c] p-0 min-w-9 min-h-9 flex align-middle justify-center items-center hover:border-[#cb202c] border-1 bg-[#cb202c] mr-1 hover:text-[#cb202c]"
        ...
        <Navbar.Collapse id="">
          ...
          <Nav className="flex-row items-start justify-center w-full pt-6 sm:justify-content-end sm:items-center sm:pt-0 sm:w-40 min-w-40">
            <Link
              to="/chat"
            ...
            {userInfo && !userInfo.isSeller && !userInfo.isAdmin ? (
              ...
              >
                ...
                <NavDropdown.Divider />
                <Link
                  className="text-sm font-semibold leading-6 text-gray-800 cursor-pointer dropdown-item "
                  to="#signout"
